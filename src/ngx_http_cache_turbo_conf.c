    ...
    ngx_http_cache_turbo_loc_conf_t *prev)
{
    ...
    ngx_conf_merge_value(conf->test_unlink_launch_hold_ms,
                         prev->test_unlink_launch_hold_ms, 0);
    ...
    ngx_conf_merge_value(conf->test_scan_del_fail,
                         prev->test_scan_del_fail, 0);
#endif
}
