...
def run_all(ng: Nginx, origin: Origin,
    ...
    test_get_head_request_body_bypasses_cache(ng, origin)
    test_method_override_headers_bypass_cache(ng, origin)
    test_malformed_get_body_framing_rejected_before_cache(ng, origin)
