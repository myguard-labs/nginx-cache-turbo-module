  ...
  #                       keepalive=0 keepalive_timeout=60s;
    ...
    server {
        ...
        location / {
            ...
            cache_turbo_use_stale         http_500 http_502 http_503 http_504;  # which statuses count as "down" (default: any 5xx)
